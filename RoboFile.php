...
require_once __DIR__ . '/build/robo/RelativeMapTask.php';
require_once __DIR__ . '/build/robo/Build.php';
require_once __DIR__ . '/build/robo/PackageParts.php';
...
class RoboFile extends Tasks
{
    ...
    public function build($params = ['dev' => false])
    {
        ...
        $this->task(\Flygcert\Robo\Tasks\Build::class, $params)->run();
    }
     ...
     *
     */
    public function map(string $target, $relative = false)
    {
        if ($relative) {
            $this->task(\Flygcert\Robo\Tasks\RelativeMapTask::class, $target)->run();
        } else {
